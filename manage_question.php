			...
			<div class="row">
				<div class="col-sm-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">질문</label>
							<textarea name="question" id="" cols="30" rows="4" class="form-control"><?php echo isset($question)? $question: '' ?></textarea>
						</div>
						<div class="form-group">
							<label for="" class="control-label">응답 타입</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<?php if(isset($id)): ?>
								<option value="" disabled="" selected="">Please Select here</option>
								<?php endif; ?>
								<option value="radio_opt" <?php echo isset($type) && $type == 'radio_opt' ? 'selected':'' ?>>단일 선택</option>
								<option value="check_opt" <?php echo isset($type) && $type == 'check_opt' ? 'selected':'' ?>>중복 선택</option>
								<option value="textfield_s" <?php echo isset($type) && $type == 'textfield_s' ? 'selected':'' ?>>텍스트상자</option>
							</select>
						</div>
				...
				<div class="col-sm-6">
					...
					<div class="preview">
						<?php if(!isset($id)): ?>
						<center><b>응답 타입을 먼저 정해주십시오.</b></center>
						<?php else: ?>
						      	...
						      	<thead>
							      	<tr class="">
								      	...
								      	<th class="text-center">
								      		<label for="" class="control-label">레이블</label>
								      	</th>
								      	<th class="text-center"></th>
							     	</tr>
						     	</thead>
...
<div id="check_opt_clone"  style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_check($(this))"><i class="fa fa-plus"></i> 추가하기 </button>
      </div>
      </div>
    </div>
</div>
<div id="radio_opt_clone" style="display: none">
	<div class="callout callout-info">
      ...
      <div class="row">
      <div class="col-sm-12 text-center">
      	<button class="btn btn-sm btn-flat btn-default" type="button" onclick="new_radio($(this))"><i class="fa fa-plus"></i>추가하기</button>
      </div>
      </div>
    </div>
</div>
<div id="textfield_s_clone" style="display: none">
	<div class="callout callout-info">
		<textarea name="frm_opt" id="" cols="30" rows="10" class="form-control" disabled=""  placeholder="작성해주십시오..."></textarea>
	</div>
</div>
<script>

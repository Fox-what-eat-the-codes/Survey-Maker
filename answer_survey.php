		...
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<h3 class="card-title"><b>설문정보</b></h3>
				</div>
			...
			<div class="card card-outline card-success">
					...
					<div class="callout callout-info">
						...
						<?php else: ?>
							<div class="form-group">
								<textarea name="answer[<?php echo $row['id'] ?>]" id="" cols="30" rows="4" class="form-control" placeholder="작성해주십시오..." ></textarea>
							</div>
						<?php endif; ?>
						</div>	
					</div>
				...
				<div class="card-footer border-top border-success">
					<div class="d-flex w-100 justify-content-center">
						<button class="btn btn-sm btn-flat bg-gradient-primary mx-1" form="manage-survey">응답 완료</button>
						<button class="btn btn-sm btn-flat bg-gradient-secondary mx-1" type="button" onclick="location.href = 'index.php?page=survey_widget'">취소</button>
					</div>
				</div>
			</div>
		</div>

		...
		<div class="card-body">
			<form action="" id="manage_survey">
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					...
					<button class="btn btn-secondary" type="button" onclick="location.href = 'index.php?page=survey_list'">취소</button>
				</div>
			</form>
		</div>
	</div>
